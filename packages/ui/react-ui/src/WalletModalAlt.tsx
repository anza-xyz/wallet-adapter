...
export interface WalletModalAlt {
    className?: string;
    featuredWallets?: number;
    container?: string;
}

export const WalletModalAlt: FC<WalletModalAlt> = ({
    className = '',
    featuredWallets = 3,
    container = 'body',
}) => {
        ...
        createPortal(
            ...
            >
                <div className="wallet-adapter-modal-container">
                    <div className={`wallet-adapter-modal-wrapper ${!wallets.length ? "wallet-modal-h-reset" : ""}`}>
                        ...
                        { !!wallets.length && <h2 className="wallet-adapter-modal-list-header">Already have a wallet? Connect with:</h2>}
