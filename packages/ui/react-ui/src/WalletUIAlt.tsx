...
export const WalletUIAlt = React.forwardRef<HTMLDivElement, WalletUIAlt>(({
    className = '',
    fadeIn,
    featured,
    getStartedWallet,
    ...
    return (
            ...
            >
                <div className="wallet-adapter-modal-container">
                    <div className={`wallet-adapter-modal-wrapper ${!featured.length ? "wallet-modal-h-reset" : ""}`}>
                        ...
                        <div className="wallet-adapter-modal-middle">
                            <WalletSVG />
                            <button type="button" className="wallet-adapter-modal-middle-button" onClick={(event)=>handleWalletClick(event,getStartedWallet)}>Get started</button>
                        </div>
                        { !!featured.length && <h2 className="wallet-adapter-modal-list-header">Already have a wallet? Connect with:</h2>}
