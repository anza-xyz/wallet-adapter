...
import { useWallet, WalletWithReadyState } from '@solana/wallet-adapter-react';
...
export const WalletModal: FC<WalletModalProps> = ({
    ...
    const [featured, more] = useMemo(() => {
        const installedWallets: WalletWithReadyState[] = [];
        const otherWallets: WalletWithReadyState[] = [];
