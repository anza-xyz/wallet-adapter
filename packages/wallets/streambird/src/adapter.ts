...
interface StreambirdWindow extends Window {
    streambird?: {
        isStreambird: boolean;
    };
    StreambirdApp?: unknown;
}
...
export class StreambirdWalletAdapter extends BaseMessageSignerWalletAdapter {
    ...
    private _params: StreambirdParams | null;
    private _connecting: boolean;
    private _wallet: import('@streambird/solana-wallet-sdk').default | null;
    ...
    constructor({ publicToken, params }: StreambirdWalletAdapterConfig = {}) {
        super();
        this._connecting = false;
        this._publicKey = null;
        this._wallet = null;
        this._publicToken = publicToken ? publicToken : '';
        this._params = params ? params : null;

        if (this._readyState !== WalletReadyState.Unsupported) {
            scopePollingDetectionStrategy(() => {
                if (window.streambird?.isStreambird || window.StreambirdApp) {
