...
export class SolletWalletAdapter extends BaseMessageSignerWalletAdapter {
    ...
    private _getProvider: () => SolletWallet | null;


    constructor(config: SolletWalletAdapterConfig = {}, getProvider: () => any = () => null) {
        super();
        this._provider = config.provider || getProvider();
